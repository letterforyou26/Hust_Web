...
export default {
  ...
  data () {
    return {
      links: [
        ['mdi-microsoft-windows', 'Dashboard', '/admin/home'],
        ['mdi-card-account-details-outline', 'News', '/admin/news'],
        ['mdi-clipboard-list-outline', 'Write', '/admin/write'],
        ['mdi-cog', 'System Settings'],
        ['mdi-logout-variant', 'Log Out', '/admin/login']
      ]
    }
  }
}
